...
import com.study.studyprojectboard.config.SecurityConfig;
import com.study.studyprojectboard.config.TestSecurityConfig;
import com.study.studyprojectboard.domain.constant.FormStatus;
import com.study.studyprojectboard.domain.constant.SearchType;
...
import com.study.studyprojectboard.dto.request.ArticleRequest;
import com.study.studyprojectboard.dto.response.ArticleResponse;
import com.study.studyprojectboard.service.ArticleService;
import com.study.studyprojectboard.service.PaginationService;
import com.study.studyprojectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    void givenPaginAndSortingParams_whenSearchingArticlesView_thenReturnsArticlesPage() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "rkoTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    @Test
    void givenUpdatedArticleInfo_whenRequesting_thenReturnsUpdatesNewArticle() throws Exception {
        // Given
        long articleId = 1L;
        ArticleRequest articleRequest = ArticleRequest.of("new title","new content");
