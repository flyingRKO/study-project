...
import com.study.studyprojectboard.domain.Hashtag;
...
import com.study.studyprojectboard.repository.HashtagRepository;
import com.study.studyprojectboard.repository.UserAccountRepository;
...
class ArticleServiceTest {
    ...
    void givenArticleInfo_whenSavingArticle_thenExtractsHashtagsFromContentAndSavesArticleWithExtractedHashtags() {
        ...
        Set<Hashtag> expecetdHashtags = new HashSet<>();
        expecetdHashtags.add(createHashtag("java"));

        given(userAccountRepository.getReferenceById(dto.userAccountDto().userId())).willReturn(createUserAccount());
        given(hashtagService.parseHashtagNames(dto.content())).willReturn(expectedHashtagNames);
        given(hashtagService.findHashtagsByNames(expectedHashtagNames)).willReturn(expecetdHashtags);
    ...
    @Test
    void givenArticId_whenDeletingArticle_thenDeletesArticle() {
        // Given
        Long articleId = 1L;
        String userId = "rko";
